...
from custom_components.mihai_ecoflow.devices import BaseDevice, DiagnosticDevice

from custom_components.mihai_ecoflow.devices.internal import (
...
from custom_components.mihai_ecoflow.devices.public import (
