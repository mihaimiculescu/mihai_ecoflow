...
from custom_components.mihai_ecoflow.devices.internal import flatten_dict
from custom_components.mihai_ecoflow.devices.internal.proto import AddressId, ef_smartmeter_pb2
